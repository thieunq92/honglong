...
<head id="Head1" runat="server">
    ...
    <meta http-equiv="refresh" content="0;URL='/Modules/Sails/Admin/RestaurantBookingByDate.aspx?NodeId=1&SectionId=15'" />
    ...
    <script type="text/javascript">
        window.location.href = window.location.href + '/Modules/Sails/Admin/RestaurantBookingByDate.aspx?NodeId=1&SectionId=15';
    </script>
</head>
<body>
                    ...
                    <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
                        <tr>
                            <td align="right" valign="top">
                                <div class="search">
                                    <div class="searchbar">
                                        <img src="/templates/os/images/search-left.png" />
                                    </div>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px">
                                            ...
                                            <tr>
                                                <td align="left" valign="top">
                                                    <input id="date3" name="date3" type="text" style="width: 65px; height: 13px; color: #B1956D; font-size: 10px" /></td>
                                                <td align="left" valign="top">
                                                ...
                                                <td width="16%" align="left" valign="top">
                                                    <a href="reservation.html">
                                                        <img src="/templates/os/images/search-bt.png" border="0" /></a></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" height="auto">
                    ...
                    <tr>
                        <td align="center" valign="bottom">
                            <img src="/templates/os/images/logo-footer.jpg" width="126" height="96" />
                        </td>
                        <td align="right" valign="bottom">
                            <div class="footer">
                                <div class="footer-bar">
                                    <img src="/templates/os/images/footer-line.jpg" /></div>

                                <div class="footer-text">
                                    <div class="contact">
                                        2009 <a href="http://www.oriental-sails.com">www.orientalsails.com</a>. All Rights Reserved
                                        <br />
                                        21 Luong Ngoc Quyen Str., Hoan Kiem Dist, Hanoi, Vietnam - Tel: 84-4-39264009 - Fax: 84-4-39264010<br />
                                        Email: <a href="mailto:sales@oriental-sails.com">sales@orientalsails.com </a>
                                    </div>
                                </div>
                            </div>
