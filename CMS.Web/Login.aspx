    ...
    <div class="box">
        ...
        <form id="Form2" method="post" runat="server">
            <div id="fields">
                <table width="333">
                    <tr>
                        <td></td>
                        <td>
                            <asp:Label ID="lblError" runat="server" EnableViewState="False" Visible="False" CssClass="validator"></asp:Label></td>
                    </tr>
                    <tr>
            ...
            <%--<div class="copyright" id="copyright">
                Product developed by <a href="http://www.bitcorp.vn">B.I.T Corp. </a>
                <br />
                <!--//  copyright / footer -->
